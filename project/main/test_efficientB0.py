...
def main():
    model_path = r'C:/Users/Acer/Desktop/cs4486/model/bestmodel_EfficientNet_B0_84_20250424_224603.pth'  # 修改为你的权重路径
    ...
    torch.nn.init.kaiming_normal_(model.conv_stem.weight, mode='fan_out', nonlinearity='relu')
